define AB = Character('IAmAB', color="#380B61")

#Main file
# $ renpy.movie_cutscene("movies/Amadeus_OP.mkv")
#screens by order
screen mcroomintro:
    imagemap:
        ground "roombg01.jpg"
...
define god = Character("Goddess Ataegina", who_outlines=[(absolute(1),"#000",absolute(0),absolute(0))], who_italic=True, color="#ffc70f")
...
#screen combatskills:
    #modal True
    #zorder 1
    #image "combat1st2.png"
    #imagebutton auto "gui/battle_%s.png" xalign 0.170 yalign 0.925 action Jump('Battlemagicskills')
    #imagebutton auto "gui/illusion_%s.png" xalign 0.260 yalign 0.925 action Jump('Illusionskills')
    #imagebutton auto "gui/heal_%s.png" xalign 0.350 yalign 0.925 action Jump('Healingskills')

    #imagebutton auto "gui/myst_%s.png" xalign 0.440 yalign 0.925 action Jump('Mysticismskills')
    #imagebutton auto "gui/summon_%s.png" xalign 0.530 yalign 0.925 action Jump('Summoningskills')
    #imagebutton auto "gui/alteration_%s.png" xalign 0.620 yalign 0.925 action Jump('Alterationskills')

    #imagebutton auto "gui/necro_%s.png" xalign 0.710 yalign 0.925 action Jump('Necromancyskills')
    #imagebutton auto "gui/attack_%s.png" xalign 0.800 yalign 0.925 action Jump('Meleeskills')

    #textbutton "Escape" xalign 0.76 yalign 1.0 action Jump('Escapeskills')

#######################################################################################################
screen stats_screen:
    modal True

    image "girlsscreenmain.png"
...
label introparents:
    ...
    katarro "But I..."
    katriona "I know, little guy... Archmage Ayna told me" #WhiskeyEdit
    katarro "If you could sense what I and the Archmage sensed" #WhiskeyEdit
    ...
    menu:
        "Yes, take me out of this nightmare{color=#1BBB20} (+1 Alignment/Healpoint later)":
            $ Points += 1
            $ cheaterfix = 1
            nvl clear
        ...
        "No, I don't want to go with you{color=#FF0000} (-1 Alignment)":
            $ Points -= 1
