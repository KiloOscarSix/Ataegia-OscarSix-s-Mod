...
label adulthood:
    ...
    $ konekocorr = 0
    menu:
        "Nod at her with a confident smile [ablovecolor] [ablove]":
            scene v015060
            with dissolve
            $ konekolove = 1
...
label afterpresentaion:
    ...
    menu:
        "Let her continue[abcorruptioncolor] [abcorruption]":
            "You decide to see what is going to happen"
            amida "Hey..."
            amida "Stop it!"
            scene v015113
            with dissolve
...
label nada02:
    ...
    $ savedgirl = False
    menu:
        "Run away and leave the girl behind[abred] [abnoalignment2]":
        ...
        "Shout to provoke the bear[abgreen] [abalignment2]":
            ...
            menu:
                AB "Choose the ones you have >= 3 or this will lead to [abred]game over{/color}."
                "Cast fear on the bear[abgreen] [abiluspoint] {image=001illusion}":
                    ...
                    if Iluspoints >= 3:
                        ...
                        "Game over"
                        return
                "Cast lightning on the bear[abgreen] [abdestpoint] {image=001battle}":
                    ...
                    if Destpoints >= 3:
                        ...
                        "Game over"
                        return
                "Summon something to fight the bear[abgreen] [absummpoint] {image=001summon}":
                    ...
                    if Summpoints >= 3:
                        ...
                        "Game over"
                        return
                "Use telekinesis on the bear[abgreen] [abmystpoint] {image=001myst}":
                    ...
                    if Mystpoints >= 3:
                        ...
                        "Game over"
                        return
                "Use a ward to protect yourself and the girl[abgreen] [abaltepoint] {image=001alteration}":
