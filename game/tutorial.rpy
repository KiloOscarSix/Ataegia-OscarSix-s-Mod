label combat_tutorial:
    ...
    menu:
        "Yes, show me how it works{color=#1BBB20} (Some points)":
            jump tutorial01
...
label endtut:
    ...
    menu:
        ...
        "Raise Summoning{color=#1BBB20} (+1 Destpoint)":

            $ Summpoints += 1
            "Your Summoning skill improved"
        "Raise Alteration{color=#1BBB20} (+1 Destpoint)":

            $ Altepoints += 1
            "Your Alteration skill improved"
        "Raise Ilusion{color=#1BBB20} (+1 Altepoint)":

            $ Iluspoints += 1
            "Your Ilusion skill improved"
        "Raise Mysticism{color=#1BBB20} (+1 Iluspoint)":
