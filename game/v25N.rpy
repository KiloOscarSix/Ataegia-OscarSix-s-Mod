label v25neutral:
    ...
    menu:
        ...
        "{color=#1BBB20}I have no idea why":
...
label v25neutral01:
    ...
    $ mountable = 0
    menu:
        AB "The second option will work if Summpoints>= 5"
...
label demonnerbyv25:
    ...
    $ demonescape = 0
    menu:
        AB "The second option will work if Mystpoints>= 3"
        "Let him go{color=#FF0000} (-1 Alignment)":
            $ Points -= 1
