label v25evil:
    ...
    menu:
        "[abgreen]What about the Archmage? She was there also":
        ...
        "I'll keep her {color=#f00} (lead to vanilla and/or group-MFF) {/color}":
            ...
            menu:
                "She's my new master of magic":
                    ...
                    jump v252ndmorn
                "[abgreen]She is helping me improve my power":
...
label trainingbred01:
    ...
    menu:
        ...
        "[abgreen]Where is Mida" if midaowner == 2:
            scene v25012
            with dissolve
        ...
        "[abgreen]Is Mida staying in my room with me?" if midaowner == 1:
            scene v25012
            with dissolve
