...
label v2openbook01:
    ...
    if readbookv2 == True:
        AB "Just skip it, it's the same information from the first book."
    else:
        pass
    menu:
        "Yes":
    ...
    if darkelftalk == 0:
        ...
        menu:
            "Yes":
                ...
                jump v2roomselect01
            "{color=#1BBB20}No, it's too risky":
                scene mcroombg01
                with dissolve
                "You leave the window"
                jump v2roomselect01
...
label v2exitroom01:
    ...
    menu:
        "Return to my room":
            ...
            jump v2roomselect01
        "{color=#1BBB20}Explore the college":
...
label liliroomcollegev2:
    if liliroomv2 == False:
        ...
        menu:
            "Well a pretty girl looks prettier with a smile{color=#1BBB20} (+1 Lili's Affection)":
                scene v2018
                with dissolve
...
label katrionav2:
    ...
    if talkwithkat == 0:
        ...
        menu:
            "{color=#1BBB20}I heard that she left the college early this morning" if darkelftalk == 1:
            ...
            "{color=#1BBB20}I heard that she left the college early this morning" if darkelftalk == 2:
                MC "I heard that she left the college early this morning"
                katriona "Really? Maybe she went to meditate somewhere"
                katriona "Strange..."
                MC "What?"
...
label hannawritterv2:
    if hannatalk == 0:
        ...
        menu:
            "It's a deal!{color=#1BBB20} (Hanna deal)":
                $ hannadealv2 = 1
                $ nextstagev2 += 1
                scene v2045
                with dissolve
...
label hannastoriesv2:
    ...
    with dissolve
    menu:
        "Tell her about your village and the attack{color=#1BBB20} (+10 Gold)" if hannamiss1 == 0:
        ...
        "Tell her about the imp that possessed the farmer{color=#1BBB20} (+10 Gold)" if hannamiss2 == 0:
        ...
        "Tell her about your village (Lie){color=#1BBB20} (+10 Gold)" if hannamiss1 == 0:
        ...
        "Tell her about the imp (Lie){color=#1BBB20} (+10 Gold)" if hannamiss2 == 0:
        ...
        "Yes":
            ...
            menu:
                "Nothing, sorry to intrude":
                    thug "Get lost!!"
                    jump villageallesterrav2
                "{color=#1BBB20}Some kind of animal I'm sure...":
...
label farmallesterrav2:
    ...
    menu:
        "{color=#1BBB20}Go talk with them":
            if farmgirlv2 == 0:
                scene v2024
                with dissolve
                MC "Hello there"
                ...
                if savedgirl == True:
                    ...
                    menu:
                        "I'm Katarro{color=#FF0000} (-1 Alignment)":
                            $ Points -= 1
                            "You got -1 Point"
                            ...
                            menu:
                                "He is, I was kidding":
                                    ...
                                    MC "I should leave"
                                    jump v2islandmap
                                "Use Illusion to charm her{color=#FF0000} (-1 Alignment/Iluspoints>= 3 to work)":
                                    ...
                                    if Iluspoints >= 3:
                                        ...
                                        menu:
                                            "Yes, I deserve it":
                                                ...
                                                $ farmgirlv2 = 3
                                                jump v2islandmap
                                            "A kiss? don't you have some gold?{color=#1BBB20} (+2 Gold)":
                                    ...
                                    if Iluspoints >= 3:
                                        ...
                                        menu:
                                            "Yes, I deserve it":
                                                ...
                                                $ farmgirlv2 = 3
                                                jump v2islandmap
                                            "A kiss? don't you have gold?{color=#1BBB20} (+2 Gold)":
...
label mountainclimbv2:
    ...
    menu:
        "{color=#1BBB20}Get inside the cave":
            MC "I should take cover inside"
            jump caveinteriorv2
        "Keep walking around{color=#FF0000} (Game over)":
